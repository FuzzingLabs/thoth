...
class TestDisassembler(unittest.TestCase):
    ...
    def test_cairo_all_builtins_functions_analyzer(self):
        ...
        self.assertEqual(
            functions_analyzer.result[0], "(0) main (entry point)\n\t- cyclomatic complexity : 2"
        )
    ...
    def test_cairo_direct_and_indirect_recursion_functions_analyzer(self):
        ...
        self.assertEqual(functions_analyzer.result[0], "(0) a\n\t- cyclomatic complexity : 9")
        self.assertEqual(functions_analyzer.result[1], "(1) b\n\t- cyclomatic complexity : 8")
        self.assertEqual(functions_analyzer.result[2], "(2) c\n\t- cyclomatic complexity : 8")
        self.assertEqual(functions_analyzer.result[3], "(3) d\n\t- cyclomatic complexity : 8")
        self.assertEqual(
            functions_analyzer.result[4], "(4) main (entry point)\n\t- cyclomatic complexity : 8"
        )
    ...
    def test_starknet_decorators3_functions_analyzer(self):
        ...
        self.assertEqual(
            functions_analyzer.result[0], "(0) __main__.balance.addr\n\t- cyclomatic complexity : 1"
        )
        self.assertEqual(
            functions_analyzer.result[1], "(1) __main__.balance.read\n\t- cyclomatic complexity : 1"
        )
        self.assertEqual(
