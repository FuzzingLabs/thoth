...
CFG_NODE_ATTR = {'style' : 'filled','shape' : 'rect', 'pencolor' : "#00000044", 'fontname' : "Helvetica,Arial,sans-serif", 'shape' : 'plaintext'}
CFG_GRAPH_ATTR = {'fontname' : "Helvetica,Arial,sans-serif", 'fontsize' : '20', 'layout' : 'dot', 'rankdir' : 'LR', 'newrank' : 'true'}
